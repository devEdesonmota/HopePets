...
<html>
  <head>
    <title>Formulário de Cadastro de Veterinário</title>
    <meta charset="utf-8" />
    <link
    ...
    <link rel="stylesheet" type="text/css" href="veterinario.css" />
  </head>
  <body>
    <div class="container form-veterinario">
      <h2 class="title-form-vet">Cadastro de Veterinário</h2>
      <form
        action="../../controller/insert/insert_veterinario.php"
        method="post"
        class="row g-3 form-space-vet"
      >
        <div class="col-md-12">
          <label for="inputEmail4" class="form-label"
            >Nome do Veterinário</label
          >
          <input
            type="text"
            class="form-control"
        ...
        <div class="col-md-4">
          <label for="inputPassword4" class="form-label">CRMV</label>
          <input
            type="text"
            class="form-control"
            id="crmv"
